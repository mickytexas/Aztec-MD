...
async function levelUp(vorterx, citel) {
  ...
  const dragonBallCharacters = ["Goku", "Vegeta", "Piccolo", "Gohan", "Trunks", "Krillin", "Android 18", "Android 17", "Lord Berrus", "Angel Whis", "Jiren Grey", "Dispo", "Top", "Son Goten", "Trunks", "Fiture Trunks", "Vegito", "Gogeta", "Majin buu", "Kid Buu", "Freiza", "Cooler", "Perfect Cell", "Archon", "Yamcha", "Tien", "Hit", "Cabba"];
