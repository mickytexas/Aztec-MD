...
function serialize(msg, vorterx) {
    ...
    msg.sender = msg.isGroup ? decodeJid(msg.key.participant) : msg.isSelf ? decodeJid(vorterx.user.id) : msg.from
    }
    if (msg.message) {
             ...
             message: quoted.quotedMessage.ephemeralMessage.message.viewOnceMessage.message
              ...
              msg.quoted = {
               ...
               message: quoted.quotedMessage.ephemeralMessage.message
                ...
                msg.quoted.isSelf = msg.quoted.participant === decodeJid(vorterx.user.id)
